    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                let indexItem: ReligiousConcept | null = null;
                ...
                if (refsParam) {
                    ...
                    const indexResponse = await religiousConceptsApi.getReligiousConcepts(1, 1, { word_english: term });
                    if (indexResponse.data && indexResponse.data.length > 0) {
                        ...
                        const arabicResponse = await religiousConceptsApi.getReligiousConcepts(1, 1, { word_arabic: term });
